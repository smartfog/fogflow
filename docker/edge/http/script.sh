...
#Below authorization token should be generated by the user only
#Below code is written for Demo purpose
#Let assume the username is "admin@test.com" and passowrd is "1234"
