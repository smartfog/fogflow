...
config.pep_port = process.env.PEP_PROXY_PORT || 5556;
...
//IDM configration
config.idm = {
  host: process.env.PEP_PROXY_IDM_HOST || '180.179.214.199',
...
config.app = {
  host: process.env.PEP_PROXY_APP_HOST || '180.179.214.211',
  port: process.env.PEP_PROXY_APP_PORT || '8060',
...
config.pep = {
  app_id: process.env.PEP_PROXY_APP_ID || '6e396def-3fa9-4ff9-84eb-266c13e93964',
  username: process.env.PEP_PROXY_USERNAME || 'pep_proxy_11d37c4c-fd5e-4fdf-9fa9-728752bcddc8',
  password: process.env.PEP_PASSWORD || 'pep_proxy_ff6a86c2-6e6f-4455-8cb3-bfc3fee254d1',
  token: {
...
config.authorization = {
  ...
  azf: {
    ...
    port: process.env.PEP_PROXY_AZF_PORT || 8090,
