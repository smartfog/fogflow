...
def publishResult(result):
    ...
    resultCtxObj['attributes']['cameraID'] = {
        'type': 'string', 'value': result['cameraID']}
    resultCtxObj['attributes']['where'] = {
        'type': 'object', 'value': result['location']}
    resultCtxObj['attributes']['when'] = {
        'type': 'string', 'value': result['date']}
    resultCtxObj['attributes']['image'] = {
        'type': 'string', 'value': result['image']}
...
def faceMatching():
    ...
    for face in faces:
        ...
        if distance < threshold:
            ...
            fileName = 'childfound-' + \
                camera['metadata']['cameraID']['value'] + \
