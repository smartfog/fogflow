...
class ngsi_data_creation:
    ...
    def get_ngsi_ld(self):
        ...
        relations = []
        relation_url = {}
        relations.append(constant.context_url1)
        relations.append(constant.context_url2)
        relation_url[self.entity_data_type] = constant.brand_url + \
            self.entity_data_type
        ...
        for i in range(length):
            ...
            relation_url[attribute_data_name] = constant.brand_url + \
                attribute_data_name
