...
# converting point metadata to ngb point metadata
    ...
    def point_type(self):
        ...
        self.logger.debug(
            "Converting python metadata to json metadata inside file point_type")
        d2 = json.dumps(d)
        location = {}
...
# for polygon type
    ...
    def polygon_type(self):
        ...
        # and coordinate.has_key('vertices')==false:
        if coordinate == constant.type_is_not_valid:
            return constant.type_is_not_valid
        ...
        self.logger.debug(
            "Converting python metadata to json metadata inside file polygon_type")
        d2 = json.dumps(d)
        location = {}
        location['type'] = "GeoProperty"
        location['value'] = d2
...
# for circle type
    def circle_type(self):
        ...
        d["coordinates"] = coordinate_data
        self.logger.debug(
            "Converting python object to json object inside file circle_type")
        d2 = json.dumps(d)
        location = {}
        location['type'] = "GeoProperty"
        location['value'] = d2
