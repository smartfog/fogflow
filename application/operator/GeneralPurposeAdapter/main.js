...
const NGSIClient = require('/app/source/ngsi/ngsiclient.js');
const NGSIAgent = require('/app/source/ngsi/ngsiagent.js');
const fogfunction = require('/app/source/function.js');
