...
def publishMySelf():
    ...
    deviceCtxObj['attributes']['url'] = {
        'type': 'string', 'value': 'http://' + profile['myIP'] + ':' + str(profile['myPort']) + '/image'}
    ...
    streamCtxObj['entityId']['id'] = 'Stream.' + \
        profile['type'] + '.' + profile['id']
    streamCtxObj['entityId']['type'] = profile['type']
    streamCtxObj['entityId']['isPattern'] = False

    streamCtxObj['attributes'] = {}
    streamCtxObj['attributes']['url'] = {
        'type': 'string', 'value': 'http://' + profile['myIP'] + ':' + str(profile['myPort']) + '/image'}

    streamCtxObj['metadata'] = {}
    streamCtxObj['metadata']['location'] = {'type': 'point', 'value': {
        'latitude': profile['location']['latitude'], 'longitude': profile['location']['longitude']}}
    streamCtxObj['metadata']['cameraID'] = {
        'type': 'string', 'value': profile['id']}
