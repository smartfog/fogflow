...
def test_subscriptionWithWrongPayload():
    ...
    r = requests.post(
        url,
        data=json.dumps(
            v2data.subscriptionWrongPaylaod),
        headers=headers)
...
def test_update_request_with_update_action():
    ...
    updateresponse = requests.post(url, data=json.dumps(
        v2data.updateDataWithupdateaction), headers=headers)
...
def test_upadte_request_with_delete_action():
    ...
    subresponse = requests.post(
        ...
        headers=headers)
    updateresponse = requests.post(url, data=json.dumps(
        v2data.deleteDataWithupdateaction), headers=headers)
    assert updateresponse.status_code == 201
...
def test_update_request_with_create_action():
    ...
    subresponse = requests.post(
        ...
        headers=headers)
    updateresponse = requests.post(url, data=json.dumps(
        v2data.createDataWithupdateaction), headers=headers)
    assert updateresponse.status_code == 201
