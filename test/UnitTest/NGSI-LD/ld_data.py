...
subdata3 = {
    'https://example.org/vehicle/brandName': [{'@type': ['https://uri.etsi.org/ngsi-ld/Property'
            ],
            'https://uri.etsi.org/ngsi-ld/hasValue': [{'@value': 'Mercedes'
            }]}],
    'https://uri.etsi.org/ngsi-ld/createdAt': [{'@type': 'https://uri.etsi.org/ngsi-ld/DateTime'
            , '@value': '2017-07-29T12:00:04'}],
    '@id': 'urn:ngsi-ld:Vehicle:A8866',
    'https://example.org/common/isParked': [{
        'https://uri.etsi.org/ngsi-ld/hasObject': [{'@id': 'urn:ngsi-ld:OffStreetParking:Downtown1'
                }],
        'https://uri.etsi.org/ngsi-ld/observedAt': [{'@type': 'https://uri.etsi.org/ngsi-ld/DateTime'
                , '@value': '2017-07-29T12:00:04'}],
        'https://example.org/common/providedBy': [{'https://uri.etsi.org/ngsi-ld/hasObject': [{'@id': 'urn:ngsi-ld:Person:Bob'
                }],
                '@type': ['https://uri.etsi.org/ngsi-ld/Relationship'
                ]}],
        '@type': ['https://uri.etsi.org/ngsi-ld/Relationship'],
        }],
    'https://uri.etsi.org/ngsi-ld/location': [{'@type': ['https://uri.etsi.org/ngsi-ld/GeoProperty'
            ],
            'https://uri.etsi.org/ngsi-ld/hasValue': [{'@value': '{ "type":"Point", "coordinates":[ -8.5, 41.2 ] }'
            }]}],
    'https://example.org/vehicle/speed': [{'@type': ['https://uri.etsi.org/ngsi-ld/Property'
            ],
            'https://uri.etsi.org/ngsi-ld/hasValue': [{'@value': 80}]}],
    '@type': ['https://example.org/vehicle/Vehicle'],
    }

# Payload  to append additional attributes to an existing entity

subdata4 = {'id': 'urn:ngsi-ld:Vehicle:A100', 'type': 'Vehicle',
            'brandName1': {'type': 'Property', 'value': 'BMW'}}

subdata4b = {'id': 'urn:ngsi-ld:Vehicle:A500', 'type': 'Vehicle',
             'brandName1': {'type': 'Property', 'value': 'BMW'}}

subdata4c = {'id': 'urn:ngsi-ld:Vehicle:A3000', 'type': 'Vehicle',
             'brandName1': {'type': 'Property', 'value': 'BMW'}}

# Payload  to patch  update specific attributes of an existing entity A100

subdata5 = {'id': 'urn:ngsi-ld:Vehicle:A100', 'type': 'Vehicle',
            'brandName1': {'type': 'Property', 'value': 'AUDI'}}

# Payload  to update the value of a specific attribute of an existing entity with wrong payload

subdata6 = {'value': 'MARUTI'}
...
subdata10 = {
    ...
    'notification': {'attributes': ['brandName'],
                     'format': 'keyValues',
                     'endpoint': {'uri': 'http://127.0.0.1:8888/ld-notify',
...
subdata12 = {
    ...
    'notification': {'attributes': ['http://example.org/vehicle/brandName2'
                     ], 'format': 'keyValues',
                     'endpoint': {'uri': 'http://127.0.0.1:8888/ld-notify',
                     'accept': 'application/json'}},
    }
...
subdata14 = {'id': 'urn:ngsi-ld:Vehicle:A800', 'type': 'Vehicle',
             'brandName1': {'type': 'Property', 'value': 'MARUTI'}}

subdata14b = {'id': 'Vehicle:A800', 'type': 'Vehicle',
              'brandName1': {'type': 'Property', 'value': 'MARUTI'}}

subdata14c = {'id': 'urn:ngsi-ld:Vehicle:A700', 'type': 'Vehicle',
              'brandName1': {'type': 'Property', 'value': 'MARUTI'}}

subdata14d = {'id': 'urn:ngsi-ld:Vehicle:A900', 'type': 'Vehicle',
              'brandName1': {'type': 'Property', 'value': 'MARUTI'}}

# Payload to  Update entity with different headers and passing inappropriate payload

subdata15 = {'id': 'urn:ngsi-ld:Vehicle:A100', 'type': 'Vehicle',
             'brandName1': {}}
...
subdata17 = {'id': 'urn:ngsi-ld:Vehicle:A900', 'type': 'Vehicle',
             'createdAt': '2017-07-29T12:00:04'}

# Payload to create entity without any attribute to be tested for delete attribute request

subdata18 = {'id': 'urn:ngsi-ld:Vehicle:A501', 'type': 'Vehicle',
             'createdAt': '2017-07-29T12:00:04'}
...
subdata25 = {'type': 'ContextSourceRegistration'}
...
subdata28 = {
    ...
    'information': [{'entities': [{'id': 'urn:ngsi-ld:Vehicle:A.*',
                    'type': 'Vehicle'}], 'properties': ['brandName',
                    'speed'], 'relationships': ['isParked']},
                    {'entities': [{'idPattern': 'pqr$',
                    'type': 'OffStreetParking'}]}],
    'endpoint': 'http://127.0.0.1:8888/csource',
    'location': '{ "type": "Point", "coordinates": [-8.5, 41.2] }',
    'timestamp': {'start': '2017-11-29T14:53:15'},
...
subdata33 = {
    ...
    'isParked': {
        'type': 'Relationship',
        'object': 'urn:ngsi-ld:OffStreetParking:Downtown1',
        'providedBy': {'type': 'person',
                       'object': 'urn:ngsi-ld:Person:Bob'},
        'parkingDate': {'type': 'Property',
                        'value': '2017-07-29T12:00:04'},
        'availableSpotNumber': {
            'type': 'Property',
            'value': '121',
...
subdata36 = {
    ...
    'notification': {'attributes': ['brandName', 'speed'],
                     'format': 'keyValues',
                     'endpoint': {'uri': 'http://127.0.0.1:8888/ld-notify',
                     'accept': 'application/json'}},
    }
...
subdata37 = {
    ...
    'type': 'Subscription',
    'entities': [{'id': 'urn:ngsi-ld:Vehicle:A3000', 'type': 'Vehicle'
                 }],
    'watchedAttributes': ['brandName', 'speed'],
    'notification': {'attributes': ['brandName', 'speed'],
                     'format': 'keyValues',
...
subdata41 = {'id': 'urn:ngsi-ld:Vehicle:A4000', 'type': 'Vehicle',
             'brandName1': {'type': 'Property', 'value': 'BMW1'}}

# to test if instance id is fetched or not

subdata42 = {'id': 'urn:ngsi-ld:Vehicle:C001', 'type': 'Vehicle',
             'brandName1': {'type': 'Property', 'value': 'BMW1',
             'instanceId': 'instance1'}}

# to test if datasetId is fetched or not

subdata43 = {'id': 'urn:ngsi-ld:Vehicle:C002', 'type': 'Vehicle',
             'brandName1': {'type': 'Property', 'value': 'BMW1',
             'datasetId': 'dataset1'}}
...
subdata59 = [{
    ...
    'isParked': {'type': 'Relationship',
                 ...
                 'providedBy': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:Person:Bob'}},
    'speed': {'type': 'Property', 'value': [12, 13]},
    'location': {'type': 'GeoProperty', 'value': {'type': 'Point',
                 'coordinates': [-8.5, 41.2]}},
    }, {
...
subdata60 = [{
    ...
    'type': 'Vehicle',
    'brandName': {'type': 'Property', 'value': ['Mercedes', 'Benz']},
    'isParked': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:OffStreetParking:Downtown1',
                 'providedBy': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:Person:Bob'}},
    ...
    'type': 'Vehicle',
    'brandName': {'type': 'Property', 'value': ['Mercedes', 'Maruti']},
    'isParked': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:OffStreetParking:Downtown1',
                 'providedBy': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:Person:Bob'}},
...
subdata62 = [{
    'id': 'urn:ngsi-ld:Vehicle:A0210',
    'type': 'Vehicle',
    'brandName': {'type': 'Property', 'value': 'Maruti'},
    'isParked': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:OffStreetParking:Downtown1',
                 'providedBy': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:Person:Bob'}},
...
subdata64 = [{
    'id': 'urn:ngsi-ld:Vehicle:A0210',
    'type': 'Vehicle',
    'brandName': {'type': 'Property', 'value': 'MarutiBenz'},
    'isParked': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:OffStreetParking:Downtown1',
                 'providedBy': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:Person:Bob'}},
...
testData74 = [{'id': 'urn:ngsi-ld:Device:water001', 'type': 'Device',
              'on': {'type': 'Property', 'value': ' '}}]

testData75 = {'id': 'urn:ngsi-ld:Device:water001', 'type': 'Device',
              'on': {'type': 'Property', 'value': ' '}}

subData80 = {'type': 'Subscription',
             'entities': [{'id': 'urn:ngsi-ld:Device:water080',
             'type': 'Device'}],
             'notification': {'format': 'normalized',
             'endpoint': {'uri': 'http://127.0.0.1:8888',
             'accept': 'application/ld+json'}}}

upsertMultipleCommand = [{'id': 'urn:ngsi-ld:Device:water001',
                         'type': 'Device', 'on1': {'type': 'Property',
                         'value': ' '}},
                         {'id': 'urn:ngsi-ld:Device:water002',
                         'type': 'Device', 'on2': {'type': 'Property',
                         'value': ' '}},
                         {'id': 'urn:ngsi-ld:Device:water003',
                         'type': 'Device', 'on3': {'type': 'Property',
                         'value': ' '}}]

upsertCommand = [{'id': 'urn:ngsi-ld:Device:water001', 'type': 'Device'
                 , 'on1': {'type': 'Property', 'value': ' '}}]

upsertCommand80 = [{'id': 'urn:ngsi-ld:Device:water080',
                   'type': 'Device', 'on1': {'type': 'Property',
                   'value': ' '}}]
...
DelData = [{
    ...
    'type': 'Device',
    'brandName': {'type': 'Property', 'value': 'xyzeee'},
    'isParked': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:OffStreetParking:Downtown1',
                 'providedBy': {'type': 'Relationship',
                 'object': 'urn:ngsi-ld:Person:Bob'}},
...
test89 = [{'id': 'urn:ngsi-ld:Device:test89', 'type': 'Device',
          'on1': {'type': 'Property', 'value': ' '}}]
