...
function printTestResult() {
    console.log("task_id", ",", "assignment_time", ",", "orchestration_time", ",", "termination_time");
    ...
    for(var tid in taskMap) {
        ...
        console.log(tid, ",", task["assignment_time"], ",", task["orchestration_time"], ",", task["termination_time"]);
