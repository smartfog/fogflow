***************************************************
FogFlow Service Orchestrator の APIs と例
***************************************************

FogFlow での IoT サービスの開発プロセス
====================================================
...
FogFlow Service Orchestrator の APIs
=========================================
...
エンティティ ID のパターンによるコンテキストをサブスクライブ
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
ジオスコープ (Geo-scope) によるコンテキストをサブスクライブ
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. note:: 条件ステートメントは、コンテキスト エンティティのドメイン メタデータでのみ定義できます。当面は、特定の属性値に基づいてエンティティを除外することはサポートされていません。
