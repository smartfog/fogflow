...
func (tb *ThinBroker) handleSouthboundCommand (w rest.ResponseWriter, ctxElem *ContextElement) {
        ...
        DEBUG.Println("Provider URL...............................", fiData.ProviderIoTAgent)
...
func (tb *ThinBroker) UpdateContext2LocalSite(ctxElem *ContextElement, params ...rest.ResponseWriter) {
        command := false
	//If any one attribute is of type "command", all the attributes will be considered as commands.
...
//Southbound feature addition ends here.
